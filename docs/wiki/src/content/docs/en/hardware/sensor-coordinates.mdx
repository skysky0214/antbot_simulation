...
:::note
To check these coordinates in the URDF, refer to [`antbot_description/urdf/antbot.xacro`](https://github.com/ROBOTIS-move/antbot/blob/main/antbot_description/urdf/antbot.xacro). For ROS topics published by each sensor, see [Key ROS Topics/Services](/antbot/en/development-guide/ros-topics/).
:::
